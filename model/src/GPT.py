            ...
            "content": [
                {
                    ...
                    "text": (
                        ...
                        "2. Następnie wygeneruj estetyczny opis mieszkania jak do ogłoszenia sprzedaży — używaj języka obrazowego, ale bez przesady. Pisz naturalnie i zachęcająco."
                    )
                },
...
image_files = [
    r"..\..\photos\kuchnia.jpg",
    r"..\..\photos\lazienka.jpg",
    r"..\..\photos\sypialnia.jpg",
    r"..\..\photos\balkon.jpg"
]
